...
_raw_corrections = {
    ...
    r"\blaseron\b": "laze'ron", r"\bblasters\b": "blarsters",
...
def orac_phonetics(text):
    for pattern, phonetic in COMPILED_CORRECTIONS:
        text = pattern.sub(lambda match, p=phonetic: _preserve_case(match, p), text)
    return text